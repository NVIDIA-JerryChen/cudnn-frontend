            ...
            for block_group in cutlass.range_constexpr(2):
                ...
                for group_iter_idx in cutlass.range(group_loop_count, unroll=1):
                    ...
                    for stage in cutlass.range_constexpr(cute.size(tdQrdQ, mode=[1])):
                        ...
                        elif const_expr(self.deterministic and stage == 0):  # noqa: SIM102 - prune specialization before runtime bounds
                        ...
                        if const_expr(delayed_group and stage == 0):  # noqa: SIM102 - prune specialization before runtime state
                            if previous_m_block >= 0:
                                barrier.arrive_inc(
                ...
                if const_expr(delayed_group):  # noqa: SIM102 - prune specialization before runtime group count
